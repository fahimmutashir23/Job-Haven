...
const CategoryJob = ({ job }) => {
  ...
  const { _id, job_title, posting_date, deadline, salary, jobNumber } = job;
    ...
    <div>
      <div className="flex justify-between items-end p-6 bg-base-300 border border-black rounded-lg shadow">
        <div className="text-xl font-semibold">
          ...
          <h2 className="flex items-center gap-2"><FaHandHoldingUsd></FaHandHoldingUsd> Salary Range : {salary}</h2>
